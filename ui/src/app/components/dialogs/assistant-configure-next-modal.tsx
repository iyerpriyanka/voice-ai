...
const makeAutomationOptions = (
...
) => [
  {
    ...
    description:
      'Gain insights from every interaction — transcripts, sentiment, quality analysis.',
  ...
  },
  {
    ...
    title: 'Webhooks',
    description:
      'Trigger external events on key actions: conversation start/end, human escalation.',
