...
import { EndpointInstructionDialog } from '@/app/components/dialogs/endpoint/endpoint-instruction-modal';

jest.mock('@/app/components/dialogs/shared/right-side-modal', () => ({
  RightSideModal: ({ children, className, label, modalOpen, title }: any) =>
    modalOpen ? (
