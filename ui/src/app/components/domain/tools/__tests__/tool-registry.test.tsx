...
jest.mock('@carbon/react', () => ({
  ...
  Button: ({
    ...
    <button aria-label={iconDescription} onClick={onClick} {...props}>
      {children}
    </button>
  ),
