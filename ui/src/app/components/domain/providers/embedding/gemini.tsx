...
type EmbeddingModel = ReturnType<typeof GEMINI_EMBEDDING_MODEL>[number];

const getModelName = (item: EmbeddingModel | null): string => item?.name ?? '';

export function ConfigureGeminiEmbeddingModel({
  onParameterChange,
  parameters,
}: {
