...
const {
  GetDefaultVADConfig,
} = require('@/app/components/domain/providers/vad/provider');
const {
  GetDefaultEOSConfig,
} = require('@/app/components/domain/providers/end-of-speech/provider');
const {
  GetDefaultMicrophoneConfig,
} = require('@/app/components/domain/providers/speech-to-text/provider');
const {
  GetDefaultNoiseCancellationConfig,
} = require('@/app/components/domain/providers/noise-removal/provider');
